# Architecture & Design: @krishnavmk/react-native-dynamic-app-icon

## 1. Overview

`@krishnavmk/react-native-dynamic-app-icon` is a React Native New Architecture library that enables **full runtime branding** — app icon, splash screen, theme, and brand configuration — without an App Store release.
